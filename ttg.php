...
if(isset($text1)){
  if($cty == "group" or $cty == "supergroup"){
    ...
    file_put_contents("stat/group.list","$guruhlarn$chat_id");
    }
  }else{
   $userlar = file_get_contents("stat/user.list");
   if(stripos($userlar,"$chat_id")!==false){
    }else{
    file_put_contents("stat/user.list","$userlarn$chat_id");
   }
  }
 }
...
if($text1 == "/start" or $text1 == "/start/dilafruzkabot"){
...
$sta = bot('sendMessage',[
'chat_id'=>$chat_id,
'text'=> "💝Sᴀʟᴏᴍ ,ᴍᴇɴɪɴɢ ɪsᴍɪᴍ <b>Dilafruz</b>.ᴅᴏsᴛʟᴀʀɪᴍ ᴇsᴀ <b>Dil</b>  ᴅᴇᴘ ᴄʜᴀǫɪʀɪsʜᴀᴅɪi!nn💝 ᴍᴇɴ ɢᴜʀᴜʜʟᴀʀᴅᴀ ɢᴀᴘʟᴀsʜᴀ ᴏʟᴀᴍᴀɴ ᴠᴀ ɢᴜʀᴜʜ ᴀᴅᴍɪɴʟᴀʀɪ ᴜᴄʜᴜɴǫᴜʟᴀʏ ʙᴏʟɢᴀɴ ʙᴜʏʀᴜǫʟᴀʀ ᴏʀǫᴀʟɪ ɢᴜʀᴜʜɴɪ ʙᴏsʜǫᴀʀɪsʜɢᴀ ᴋᴏᴍᴀᴋʟᴀsʜᴀᴍᴀɴ!nn💝Admin: @ziyodullabek_official",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'🔴ʙᴜʏʀᴜǫʟᴀʀ🔴', 'callback_data' => "stat"],['text'=>'⚫sᴛᴀᴛɪsᴛɪᴋᴀ⚫', 'callback_data' => "stat1"]],
          [['text'=>'🔵ɢᴜʀᴜʜɢᴀ ǫᴏsʜɪsʜ🔵','url'=>'telegram.me/dilafruzkabot?startgroup=new']]
]   
]),
]);
}
...
$bugun = date('d-M Y',strtotime('0 hour'));
   ...
   'chat_id'=>$chat_id2,
    ...
    'text'=> "💝<b>Bot ⚫sᴛᴀᴛɪsᴛɪᴋᴀ⚫si:</b>nn👤A'zolar: <b>$us</b>n👥Guruhlar: <b>$gr</b>n📣Umumiy: <b>$obsh</b>nn$bugun $soat",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
  [['text'=>'➰ʏᴀɴɢɪʟᴀsʜ➰', 'callback_data' => "stat1"]],
  [['text'=>'🔵ɢᴜʀᴜʜɢᴀ ǫᴏsʜɪsʜ🔵','url'=>'telegram.me/dilafruzkabot?startgroup=new']]
]
]),
]);
...
<b>plusadmin</b> - Guruh a‘zosini guruhga admin qiladi;
<b>deladmin</b> - Adminlikdan oladi.

- Bot guruh yangi a‘zolari bilan salomlashadi.Guruh a‘zosi guruhga reklama <b>ssilkalarini</b> tashlasa yoki <b>haqoratli</b> so‘z yozsa,bot xabarni o‘chirib foydalanuvchiga cheklov beradi.nn<b>Yaratuvchi🛠:</b>  <a href='tg://user?id=5147450029'>Ziyodullabek</a>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
[['url' => 'https://telegram.me/dilafruzkabot?startgroup=new', 'text' => "🔵ɢᴜʀᴜʜɢᴀ ǫᴏsʜɪsʜ🔵"],],
]
]),
]);
}

if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@Dilafruzkabot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
[['url' => 'https://telegram.me/dilafruzkabot?startgroup=new', 'text' => "🔵ɢᴜʀᴜʜɢᴀ ǫᴏsʜɪsʜ🔵"],],
    ...
    if($data == "admin"){
      bot('answerCallbackQuery',[
       ...
       'text'=> "😙ʙᴏᴛ ᴀᴅᴍɪɴɪ @Ziyodullabek_official",
       'show_alert'=>true
        ]);
    }
...
if((stripos($mtext,"bot")!==false) or (stripos($mtext,"bot ochib berin")!==false)  or (stripos($mtext,"php tashang")!==false)  or (stripos($mtext,"bot")!==false)){
$input = array("Nima Gapin Bor","Yoq Ochmima","Ozin Ochvol😆","tashamima😂.","Oneni Telegramidayam Mendaqa Botla Bormi😂😆");
  $rand=rand(0,4);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
 ...
 if($fadmin==$admin){
    bot('sendmessage',[
      'chat_id'=>$chat_id,
      'text'=>"Vay mana meni yaratgan inson keldilar 😘 @(stripos($mtext,"Qo'qon")!==false) or  cham😉.",
      ]);
  }else{
  $name = $message->from->first_name;
...
if((stripos($mtext,"Dilafruz") !== false) or (stripos($mtext,"MarjonaXonBo") !== false) or (stripos($mtext,"Asalim") !== false) or (stripos($mtext,"Jonim")!==false)){
...
if(stripos($mtext,"kimsan")!== false){
  $name = $message->from->first_name;
  $input = array("Ammangni qiziman😂","Poxxuy emasmi 😂.","Hazilkash robotcha!","kim deb o‘ylaysiz?","@Ziyodullabek_official kanalining adminkasiz ShohzodaXon_RoBoT man😜","Kapitan Telegram","ShohzodaXon_RoBoT, yana Masha bilan adashtirib yubormeng😂","Sirliman🎩","O‘ziz kimsiz?","Har doim shu savolni  beruvirib charchamadizmi?","Tinchlikmi kimligim bilan qiziqib qolibsiz!?","Menmi?","Nima edi😡...Vux qo‘rqib ketdiza?","Selena Gomes,","Aytsam sizni oldirishga togri keladi");
  $rand=rand(0,13);
  $soz="$input[$rand]";
  $a=json_encode(bot('sendmessage',[
   'reply_to_message_id'=>$mesid,
...
if((mb_stripos($mtext,"#Yaratuvchi") !== false)){ 
bot('SendMessage',[
'chat_id'=>$chat_id,
...
if((mb_stripos($mtext,"#xon") !== false) or (mb_stripos($mtext,"xon")!==false) or (stripos($mtext,"blogger")!==false) or (mb_stripos($mtext,"admin")!==false) or (mb_stripos($mtext,"зед")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
'text'=>"✉<b>$title(</b>  $chat_id  <b>) guruhida sizni eslashdi:</b>n<code>$mtext</code>n  <b>Xabarchi  haqida  ma'lumotlar: </b>
...
if($get =="member"){
    ...
    bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "💝 <a href='tg://user?id=$fadmin'>$first_name</a> siz <b>10 daqiqaga</b>ga <b>Read only</b> rejimiga tushdingiz.n⚠ <b>Sabab:</b> <i>Reklama!</i> ",
        'parse_mode' => 'html'
    ]);
}
}
  ...
  if($get =="member"){
    ...
    bot('sendmessage', [
        'chat_id' => $chat_id,
        'text' => "💝 <a href='tg://user?id=$fadmin'>$first_name</a> <b>15 daqiqaga</b>ga <b>Read only</b> rejimiga tushdirildi.n⚠ <b>Sabab:</b> <i>Haqorat qildi!</i> ",
        'parse_mode' => 'html'
    ]);
}
}

 if($text1 == "plusadmin" or $text1 == "plusadmin"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="administrator" or $get == "creator"){
  ...
  bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>"☑ <a href='tg://user?id=$id'>$from_user_first_name</a> sizdan cheklov olindi, guruhda <b>yozishingiz mumkin!</b>nEndi qoidani <b>buzmaysiz</b> degan umiddaman❗️",
    'parse_mode'=>'html'
  ]);
}
}
